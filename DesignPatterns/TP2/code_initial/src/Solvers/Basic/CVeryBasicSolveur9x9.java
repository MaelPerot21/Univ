package Solvers.Basic;

import Datas.CGrille9x9;
import Solvers.Factory.SolverFactory;

public class CVeryBasicSolveur9x9 implements SolverFactory {
	...
	private String chiffresPossibles(CGrille9x9 g, int l, int c) {
		...
		/* invalide les chiffre sur la ligne */

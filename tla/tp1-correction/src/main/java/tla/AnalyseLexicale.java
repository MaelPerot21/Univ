...
public class AnalyseLexicale {
	...
	private static Integer TRANSITIONS[][] = {
			...
			/*  0 */    {      0, 101, 102, 103, 104, 105,   1,   2,       3,      4  },
			/*  1 */    {    106, 106, 106, 106, 106, 106, 107, 106,     106,    106  },
			/*  2 */    {    108, 108, 108, 108, 108, 108, 109, 108,     108,    108  },
			/*  3 */    {    110, 110, 110, 110, 110, 110, 110, 110,       3,    110  },
			/*  4 */    {    111, 111, 111, 111, 111, 111, 111, 111,       4,      4  }
			...
			// 108 acceptation d'un !                        (retourArriere)
			// 109 acceptation d'un !=
			// 110 acceptation d'un entier                   (retourArriere)
			// 111 acceptation d'un identifiant ou mot clé   (retourArriere)
		...
		do {
			...
			if (e >= 100) {
				if (e == 101) {
					...
					tokens.add(new Token(TypeDeToken.assign));
					retourArriere();
				} else if (e == 107) {
					tokens.add(new Token(TypeDeToken.equal));
				} else if (e == 108) {
					tokens.add(new Token(TypeDeToken.logicalNeg));
					retourArriere();
				} else if (e == 109) {
					tokens.add(new Token(TypeDeToken.notEqual));
				} else if (e == 110) {

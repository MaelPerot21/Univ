...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Logement_fct flat_test1 = new Logement_fct(1,184,1,2);
        Logement_fct flat_test2 = new Logement_fct(1,100,1,1);
        Logement_sociaux flat_test3 = new Logement_sociaux(1,40,40,6);
        Logement_sociaux flat_test4 = new Logement_sociaux(1,7000,100,1);
